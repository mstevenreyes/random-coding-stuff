...
export function Welcome() {
  ...
  function AddTodoList (){
    setTodoList([
      ...todoList,
      {
        id: todoListId.current,
        task: `task${todoListId.current}`
      }
    ]);
    todoListId.current = todoListId.current + 1;
  }

  function selectTodoItem(e: any){
    const todoItemId = Number(e.target.dataset['taskid'])
    if(e.target.checked){
